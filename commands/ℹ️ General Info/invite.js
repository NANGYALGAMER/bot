...
const embed = new Discord.MessageEmbed()
  ...
  .setColor('RANDOM')
  .addField("Invite to Discord server", "(Admin Perm)](https://discord.com/api/oauth2/authorize?client_id=892307091266600980&permissions=8&scope=bot)")
  .addField("Server", `[Join to official server](https://discord.gg/D7VrK8ZGY7)`)
  .setFooter("Bot created by Nangyal")
